  ...
  const renderPlayerItem = ({ item: player }: { item: Player }) => {
    ...
    return (
      <TouchableOpacity
        ...
        activeOpacity={0.7}
        className={`bg-white mx-4 mb-3 rounded-xl border ${
          ...
          <View className="flex-1">
            ...
            <View className="flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <Text className="text-gray-500 text-sm ml-1">{player.YoB}</Text>
              </View>
      ...
      <View className="flex-1 bg-gray-50">
        ...
        <View className="flex-1 justify-center items-center px-6">
          ...
          <Text className="text-gray-600 text-center leading-relaxed">
            Hãy thêm những cầu thủ bạn yêu thích vào danh sách để theo dõi thông
            tin của họ
          </Text>
          <TouchableOpacity
